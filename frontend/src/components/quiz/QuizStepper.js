...
const QuizStepper = () => {
	...
	const renderStepContent = () => {
		switch (currentStep) {
			case 1:
				return (
					<div>
						<h3 style={{ color: "#091057" }} className="mb-2">I want to take a quiz on:</h3>
						<select
			...
			case 2:
				return (
					<div>
						<h4 style={{ color: "#091057" }} className="mb-2">How many questions would you like to attempt?</h4>
						<input
							type="number"
			...
			case 3:
				return (
					<div>
						<h2 style={{ color: "#024CAA" }}>Confirmation</h2>
		...
		return (
			<div className="progress">
				<div
					...
					role="progressbar"
					style={{ width: `${progress}%`, backgroundColor: "#024CAA" }}
	...
	return (
		<section className="mt-5">
			<h3 style={{ color: "#091057" }} className="mb-4">
